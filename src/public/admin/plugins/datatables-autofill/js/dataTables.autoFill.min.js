...
$jscomp.getGlobal = function(c) { c = ["object" == typeof globalThis && globalThis, c, "object" == typeof window && window, "object" == typeof self && self, "object" == typeof global && global]; for (var h = 0; h < c.length; ++h) { var g = c[h]; if (g && g.Math == Math) return g } throw Error("Cannot find global object"); };
...
$jscomp.polyfill = function(c, h, g, k) { h && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(c, h, g, k) : $jscomp.polyfillUnisolated(c, h, g, k)) };
...
$jscomp.polyfillIsolated = function(c, h, g, k) {
    ...
    h = h(g);
    null != h && (c ? $jscomp.defineProperty($jscomp.polyfills, l, { configurable: !0, writable: !0, value: h }) : h !== g && ($jscomp.propertyToPolyfillSymbol[l] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(l) : $jscomp.POLYFILL_PREFIX + l, l =
...
$jscomp.polyfill("Symbol", function(c) {
    ...
    var g = 0,
        k = function(l) { if (this instanceof k) throw new TypeError("Symbol is not a constructor"); return new h("jscomp_symbol_" + (l || "") + "_" + g++, l) };
    return k
}, "es6", "es3");
...
$jscomp.iteratorFromArray = function(c, h) {
    ...
    var g = 0,
        k = {
            next: function() {
                if (g < c.length) { var l = g++; return { value: h(l, c[l]), done: !1 } }
                k.next = function() { return { done: !0, value: void 0 } };
                return k.next()
            }
        };
...
(function(c) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(h) { return c(h, window, document) }) : "object" === typeof exports ? module.exports = function(h, g) {
        h || (h = window);
    ...
    var l = c.fn.dataTable,
        ...
        r = function(a, d) {
            ...
            this.c = c.extend(!0, {}, l.defaults.autoFill,
                r.defaults, d);
            ...
            this.dom = {
                ...
                list: c('<div class="dt-autofill-list">' + this.s.dt.i18n("autoFill.info",
                    "") + "<ul/></div>"),
                dtScroll: null,
                offsetParent: null
            };
    ...
    c.extend(r.prototype, {
        ...
        enable: function(a) {
            ...
            this.s.enabled = !0;
            this._focusListener();
            this.dom.handle.on("mousedown", function(b) { d._mousedown(b); return !1 });
            return this
        },
        disable: function() {
            this.s.enabled = !1;
        ...
        _constructor: function() {
            ...
            d.on("destroy.autoFill", function() { a._focusListenerRemove() })
        },
        _attach: function(a) {
            var d = this.s.dt,
                b = d.cell(a).index(),
                e = this.dom.handle,
                f = this.s.handle;
            b && -1 !== d.columns(this.c.columns).indexes().indexOf(b.column) ? (this.dom.offsetParent || (this.dom.offsetParent = c(d.table().node()).offsetParent()), f.height && f.width || (e.appendTo("body"), f.height =
        ...
        _actionSelector: function(a) {
            var d = this,
                ...
                e = r.actions,
                f = [];
            c.each(e, function(p, q) { q.available(b, a) && f.push(p) });
        ...
        _editor: function(a) {
            ...
            if (b) {
                for (var e = {},
                        f = [], m = b.fields(), n = 0, p = a.length; n < p; n++)
                    for (var q = 0, v = a[n].length; q < v; q++) {
                        var u = a[n][q],
                            w = d.settings()[0].aoColumns[u.index.column],
                            t = w.editField;
                        if (t === k) { w = w.mData; for (var x = 0, z = m.length; x < z; x++) { var A = b.field(m[x]); if (A.dataSrc() === w) { t = A.name(); break } } }
        ...
        _focusListener: function() {
            ...
            if ("focus" === e) d.on("key-focus.autoFill", function(f, m, n) { a._attach(n.node()) }).on("key-blur.autoFill", function(f, m, n) { a._detach() });
            else if ("click" === e) c(d.table().body()).on("click" + b, "td, th", function(f) { a._attach(this) }), c(g.body).on("click" + b, function(f) {
        ...
        _getPosition: function(a, d) {
            ...
            do {
                ...
                b += f + 1 * parseInt(n.css("border-top-width") ||
                    0);
        ...
        _mousedown: function(a) {
            ...
            c(g.body).on("mousemove.autoFill", function(f) { d._mousemove(f) }).on("mouseup.autoFill", function(f) { d._mouseup(f) });
        ...
        _mousemove: function(a) { var d = a.target.nodeName.toLowerCase(); if ("td" === d || "th" === d) this._drawSelection(a.target, a), this._shiftScroll(a) },
        _mouseup: function(a) {
            ...
            if (e.row !== f.row || e.column !== f.column) {
                ...
                if (c("div.DTE", m.node()).length) {
                    ...
                    f = [];
                    for (var q = b.settings()[0], v = q.aoColumns, u = b.columns(this.c.columns).indexes(), w = 0; w < p.length; w++) f.push(c.map(e, function(t) {
        ...
        _shiftScroll: function(a) {
            ...
            null !== b.dtLeft && a.pageX <
                b.dtLeft + 65 ? v = -5 : null !== b.dtLeft && a.pageX > b.dtLeft + b.dtWidth - 65 && (v = 5);
            ...
            if (!1 !== a) {
                ...
                if (null !== this.c.update ? this.c.update : !this.c.editor) {
                    for (var e = 0, f = d.length; e < f; e++)
                        for (var m = 0, n = d[e].length; m < n; m++) { var p = d[e][m]; - 1 !== b.indexOf(p.index.column) && p.cell.data(p.set) }
                    a.draw(!1)
                }
    ...
    r.actions = {
        increment: {
            available: function(a, d) { a = d[0][0].label; return !isNaN(a - parseFloat(a)) },
            option: function(a,
                d) { return a.i18n("autoFill.increment", 'Increment / decrement each cell by: <input type="number" value="1">') },
        ...
        fill: {
            available: function(a, d) { return !0 },
            option: function(a, d) { return a.i18n("autoFill.fill", "Fill all cells with <i>%d</i>", d[0][0].label) },
            execute: function(a, d, b) {
                a = d[0][0].data;
                b = 0;
                for (var e = d.length; b < e; b++)
                    for (var f = 0, m = d[b].length; f < m; f++) d[b][f].set =
                        a
            }
        },
        fillHorizontal: {
            available: function(a, d) { return 1 < d.length && 1 < d[0].length },
            option: function(a, d) { return a.i18n("autoFill.fillHorizontal", "Fill cells horizontally") },
            execute: function(a, d, b) {
                a = 0;
        ...
        fillVertical: {
            available: function(a, d) { return 1 < d.length },
            option: function(a, d) { return a.i18n("autoFill.fillVertical", "Fill cells vertically") },
            execute: function(a, d, b) {
                a = 0;
                for (b = d.length; a < b; a++)
                    for (var e = 0, f = d[a].length; e < f; e++) d[a][e].set =
                        d[0][e].data
            }
        },
    ...
    B.register("autoFill()", function() { return this });
    B.register("autoFill().enabled()", function() { var a = this.context[0]; return a.autoFill ? a.autoFill.enabled() : !1 });
    B.register("autoFill().enable()",
        function(a) { return this.iterator("table", function(d) { d.autoFill && d.autoFill.enable(a) }) });
    B.register("autoFill().disable()", function() { return this.iterator("table", function(a) { a.autoFill && a.autoFill.disable() }) });
    c(g).on("preInit.dt.autofill", function(a, d, b) { "dt" === a.namespace && (a = d.oInit.autoFill, b = l.defaults.autoFill, a || b) && (b = c.extend({}, a, b), !1 !== a && new r(d, b)) });
    l.AutoFill = r;
    return l.AutoFill = r
});